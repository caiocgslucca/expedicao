...
<head>
    ...
    <title>Histórico-Finalizado-Romaneio</title>
</head>
...
<body>
    ...
    <!-- <div class="row row-cols-1 row-cols-md-12"> -->
        ...
        <form action="" method="POST">
            ...
            <!-- <div style=""> -->
                ...
                <ul class="nav nav-tabs justify-content-center py-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="recebido_romaneio">Hitórico Romaneio</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="historico_finalizado_romaneio">Histórico Finalizado Romaneio</a>
                    </li>
                </ul>
        ...
        ?>
            <?php
            echo '<td><a button class="btn btn-success" href="export_finalizado_romaneio.php?dateini=' . "" . '">Clique aqui para fazer o download <p> Referente à Data: ' . $data . '</p> </a></td>';
            echo "<br>";
            ?>
                    </div>
