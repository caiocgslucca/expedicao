...
<button data-toggle="modal" data-target="#deletar_pedido<?php echo $pedido ?>" type="submit" class="btn btn-danger">Excluir</button>
                                                    ...
                                                    <form action="deletar_pedido_romaneio.php" method="POST">
                ...
                <div class="card card-body">
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            // LEFT OUTER JOIN `expedicao_recebido` as recebido  on recebido.nro_etiqueta = producao.nro_etiqueta and recebido.deleted_at IS NULL
                            // WHERE producao.deleted_at IS NULL and producao.nro_etiqueta = '$pedido' 
                            //  ORDER by `id` DESC");
                            ...
                            WHERE producao.deleted_at IS NULL and producao.finalizado IS NULL and producao.nro_pedido = '$pedido'
