...
$arquivo = $datahora.'_'.'recebido_romaneio.xls';
    ...
    <table>
        <thead>
            <tr>
                            ...
                            <th class="th-sm">Nro. Romaneio Expedicao</th>
        ...
        <tbody>
            ...
            LEFT OUTER JOIN `expedicao_recebido` as recebido  on recebido.nro_etiqueta = producao.nro_etiqueta and recebido.finalizado IS NULL and recebido.deleted_at IS NULL
            WHERE producao.`data_hora` BETWEEN '$data 00:00:00' AND '$data 23:59:59' and producao.finalizado IS NULL and producao.deleted_at IS NULL
             ORDER by `id` ASC");
...
<thead>
                    ...
                    <tbody>
                        ...
                        FROM `expedicao` as producao
                        LEFT OUTER JOIN `expedicao_recebido` as recebido  on recebido.nro_etiqueta = producao.nro_etiqueta and recebido.finalizado IS NULL and recebido.deleted_at IS NULL
                        WHERE producao.`data_hora` BETWEEN '$Datainicio 00:00:00' AND '$Datafinal 23:59:59' and producao.finalizado IS NULL and producao.deleted_at IS NULL
                         ORDER by `id` ASC");
