...
$select = "INSERT INTO pcp_recebido (pacote, pedido, nota_fiscal, usuario, data_hora, obs)
SELECT producao.pacote, producao.pedido, producao.nota_fiscal, '$usuario', '$datahora', '$obs'
FROM `db` as producao
